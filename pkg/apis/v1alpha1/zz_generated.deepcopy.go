...
func (in *GCENodeClassSpec) DeepCopyInto(out *GCENodeClassSpec) {
	*out = *in
	...
	if in.SubnetRangeNames != nil {
		in, out := &in.SubnetRangeNames, &out.SubnetRangeNames
...
func (in *GCENodeClassStatus) DeepCopyInto(out *GCENodeClassStatus) {
	*out = *in
	...
	if in.SubnetRanges != nil {
		in, out := &in.SubnetRanges, &out.SubnetRanges
		*out = make([]SubnetRangeStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubnetRangeStatus) DeepCopyInto(out *SubnetRangeStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubnetRangeStatus.
func (in *SubnetRangeStatus) DeepCopy() *SubnetRangeStatus {
	if in == nil {
		return nil
	}
	out := new(SubnetRangeStatus)
	in.DeepCopyInto(out)
	return out
}

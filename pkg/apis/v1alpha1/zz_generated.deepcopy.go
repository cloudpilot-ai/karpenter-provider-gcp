...
func (in *GCENodeClassSpec) DeepCopyInto(out *GCENodeClassSpec) {
	*out = *in
	...
	if in.SubnetworkSelectorTerms != nil {
		in, out := &in.SubnetworkSelectorTerms, &out.SubnetworkSelectorTerms
		*out = make([]SubnetworkSelectorTerm, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubnetworkSelectorTerm) DeepCopyInto(out *SubnetworkSelectorTerm) {
	*out = *in
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubnetworkSelectorTerm.
func (in *SubnetworkSelectorTerm) DeepCopy() *SubnetworkSelectorTerm {
	if in == nil {
		return nil
	}
	out := new(SubnetworkSelectorTerm)
	in.DeepCopyInto(out)
	return out
}

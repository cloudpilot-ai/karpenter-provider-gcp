...
type InstanceMetadata struct {
	// sourceMetadata contains explicitly retained GKE source-template metadata
	// items. This is not an arbitrary passthrough; FromSourceTemplate only copies
	// keys listed in retainedSourceMetadataKeys.
...
// KubeEnvEntries contains parsed kube-env KEY: value entries outside KUBELET_ARGS.

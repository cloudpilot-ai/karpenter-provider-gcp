...
func TestResolveLatestCOSImage_ExcludesSpecialisedVariants(t *testing.T) {
	images := []*compute.Image{
		// cgpv1 has the newest timestamp — must be excluded (GKE 1.29+ kubelet crashes on cgroup v1)
		{Name: "gke-1353-gke1389001-cos-125-19216-220-106-c-cgpv1-pre", CreationTimestamp: "2025-04-11T00:00:00Z"},

	...
	tests := []struct {
	...
	}{
		{
			...
			expected: scheduling.NewRequirements(
				...
				scheduling.NewRequirement(v1alpha1.LabelInstanceFamily, corev1.NodeSelectorOpIn, "n1-standard"),
		...
		},
		{
			...
			expected: scheduling.NewRequirements(
				...
				scheduling.NewRequirement(v1alpha1.LabelInstanceFamily, corev1.NodeSelectorOpIn, "t2a-standard"),
				scheduling.NewRequirement(v1alpha1.LabelInstanceShape, corev1.NodeSelectorOpIn, "standard"),
		...
		},
		{
			...
			expected: scheduling.NewRequirements(
				...
				scheduling.NewRequirement(v1alpha1.LabelInstanceFamily, corev1.NodeSelectorOpIn, "a2-highgpu"),
		...
		},
		{
			...
			expected: scheduling.NewRequirements(
				...
				scheduling.NewRequirement(v1alpha1.LabelInstanceFamily, corev1.NodeSelectorOpIn, "c3d-highmem"),

...
// excluded. Used for bare z3-highmem names that are duplicates of their
// -highlssd/-standardlssd variants.
var machineTypeExactBlacklist = map[string]bool{
	// Bare z3-highmem without lssd suffix — duplicates of the -highlssd/-standardlssd variants.
	"z3-highmem-88":  true,
	"z3-highmem-176": true,
